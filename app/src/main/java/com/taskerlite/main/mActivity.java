...
import com.taskerlite.receiver.AlarmBR;
...
public class mActivity extends Activity implements FragmentCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileController = Settings.getInstance(this).getProfileController();
        ...
        AlarmBR alarmBR = new AlarmBR();
        alarmBR.CancelAlarm(this);
        alarmBR.setOnetimeTimer(this);
    }
