...
/*
    public static ActionBuilderDialog newInstance(Context context){

        ActionBuilderDialog dialogFragment = new ActionBuilderDialog();
        Bundle bundle = new Bundle();
        bundle.putAll((FragmentTaskBuilder)context);
